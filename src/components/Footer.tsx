...
export default function Footer() {
    return (
        <motion.footer
            ...
            className="h-85 md:h-100 lg:h-130 mt-20">
            ...
            <div className="border-t-1 border-[#2d2d2d] mt-1 lg:mt-2 pt-2 md:pt-4 text-center m-5 lg:m-15 text-[9px] md:text-[11px]  lg:text-[13px]">
