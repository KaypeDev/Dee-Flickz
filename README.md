...
- **9/6/25**
It's been two weeks since my last commit. I usually don't push code often — I tend to keep everything local until the feature is fully working. Here’s what I’ve been up to:
...
-Started coding in the second week, and finished the layout midweek.
-Integrated Convex into the booking form, which took up most of the rest of the week.
-Built a multi-step form that lets users:
    -Pick a date
...
-This was my first time working with multi-step forms and Convex. It was honestly pretty frustrating — especially defining mutations, querying available dates, and getting createMutation to work properly — but it was also very rewarding.
